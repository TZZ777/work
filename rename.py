...
dict_t = {
  ...
  "rules": {
    ...
    "财务报表1": {"keywords": ["合并财务报表","财务报表","会计报表","年度报表"], "folders": ["承租人"], "tag": "#承租人财务报表#", "flag":False},
    "财务报表2": {"keywords": ["合并财务报表","财务报表","会计报表","年度报表"], "folders": ["担保人"], "tag": "#担保人财务报表#", "flag":False},
    ...
    "担保明细1": {"keywords": ["担保明细","担保明细表","担保情况"], "folders": ["承租人"], "tag": "#承租人担保明细#", "flag":True},
    "担保明细2": {"keywords": ["担保明细","担保明细表","担保情况"], "folders": ["担保人"], "tag": "#担保人担保明细#", "flag":True},
    "有息负债明细1": {"keywords": ["融资明细","借款明细","银行贷款","融资.xlsx","融资.xls"], "folders": ["承租人"], "tag": "#承租人有息负债明细#", "flag":True},
    "有息负债明细2": {"keywords": ["融资明细","借款明细","银行贷款","融资.xlsx","融资.xls"], "folders": ["担保人"], "tag": "#担保人有息负债明细#", "flag":True},
    "法定代表人简历1": {"keywords": ["法人简历","法定代表人简历表"], "folders": ["承租人"], "tag": "#承租人法定代表人简历#", "flag":True},
    ...
    "法定代表人身份证1": {"keywords": ["法人身份证","法定代表人身份证表"], "folders": ["承租人"], "tag": "#承租人法定代表人身份证#", "flag":True},
    "法定代表人身份证2": {"keywords": ["法人身份证","法定代表人身份证表"], "folders": ["担保人"], "tag": "#担保人法定代表人身份证#", "flag":True},
